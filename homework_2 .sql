...
values(1, 'John', 'Doe', 'jd23@gmail.com', '1234-4567-9012-3456')

insert into customer(customer_id, first_name, last_name, email, billing_info)
values(2, 'Jane', 'Doe', 'fr229@yahoo.com', '2345-0987-1234-7654')

insert into customer(customer_id, first_name, last_name, email, billing_info)
values(3, 'James', 'White', 'JW99@gmail.com', '7890-0987-1234-5678')

insert into customer(customer_id, first_name, last_name, email, billing_info)
values(4, 'Tom', 'Jones', 'tj55@aol.com', '1245-0987-3445-6543')
...
values(1, 'Show Time', '143','1-2-2021');

insert into movie(movie_id, movie_name, movie_length, movie_date)
values(2, 'Spongebob', '260', '1-2-2021');

insert into movie(movie_id, movie_name, movie_length, movie_date)
values(3, 'Scream', '140', '1-2-2021');

insert into movie(movie_id, movie_name, movie_length, movie_date)
values(4, 'Hot date', '145', '1-2-2021')
